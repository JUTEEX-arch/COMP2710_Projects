// NOTE to the grader, the include malloc.h doesnt work for me, it gives an error, so I commented it out, the code still works, but gives warnings.
// NOTE_2, nevermind, it works fine on the linux server
#include <stdio.h>
#include <stdlib.h>
#include <malloc.h>
#include <time.h>
...
int main(int argc, char **argv)
{
    ...
    sem_init(&m, 0, N - 1); // allow at most N-1 philosophers to pick up first chopstick
